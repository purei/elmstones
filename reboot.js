...
var _user$project$Types$baseComm = A2(
	_user$project$Types$Commander,
	_user$project$Types$CommanderData(1),
	0);
var _user$project$Types$baseArmy = A4(
	_user$project$Types$Army,
	_user$project$Types$baseComm,
	{ctor: '[]'},
	{ctor: '[]'},
	_elm_lang$core$Array$empty);
var _user$project$Types$baseBattle = A3(_user$project$Types$Battle, _user$project$Types$baseArmy, _user$project$Types$baseArmy, 1);
var _user$project$Types$initComm = function (commander) {
	return A2(_user$project$Types$Commander, commander, 0);
};
var _user$project$Types$initArmy = function (player) {
	return A4(
		_user$project$Types$Army,
...
var _user$project$Types$baseUnit = A3(
...
var _user$project$Simulator$remove = F2(
	function (n, arr) {
		return A2(
			_elm_lang$core$Array$append,
			A3(_elm_lang$core$Array$slice, 0, n, arr),
			A3(
...
var _user$project$Simulator$init = {ctor: '_Tuple2', _0: _user$project$Types$baseBattle, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Simulator$setupBattle = function (matchup) {
	return {
		offense: _user$project$Types$initArmy(matchup.attacker),
		defense: _user$project$Types$initArmy(matchup.defender),
		turn: 1
	};
};
...
var _user$project$Simulator$addToHand = function (battle) {
	...
	var _p2 = _user$project$Simulator$disconnectHead(offense.deck);
	var hand = _p2._0;
	var deck_ = _p2._1;
	var hand_ = {ctor: '::', _0: hand, _1: offense.hand};
...
var _user$project$Simulator$playCard = F2(
	function (pos, battle) {
		var offense = battle.offense;
		var _p3 = _user$project$Simulator$disconnectHead(offense.hand);
		var card = _p3._0;
		var hand_ = _p3._1;
...
var _user$project$Simulator$goto = function (x) {
	return A2(
		_elm_lang$core$Task$perform,
...
var _user$project$Simulator$lineMap = F2(
	function (fn, side) {
		return _elm_lang$core$Native_Utils.update(
			side,
			{
				line: A2(_elm_lang$core$Array$map, fn, side.line)
			});
	});
...
var _user$project$Simulator$lineFilter = F2(
	function (bfn, side) {
		return _elm_lang$core$Native_Utils.update(
			side,
			{
				line: A2(_elm_lang$core$Array$filter, bfn, side.line)
			});
	});
...
var _user$project$Simulator$quickChoice = false;
...
var _user$project$Simulator$report = function (battle) {
	return {
		ctor: '_Tuple2',
		_0: battle,
		_1: _user$project$Simulator$currentState(battle)
	};
};
var _user$project$Simulator$battleEnd = _elm_lang$core$Native_Platform.outgoingPort(
	'battleEnd',
	function (v) {
		return [
			v._0,
			...
			offense: {
				commander: {
					base: {health: v._1.offense.commander.base.health},
					damage_taken: v._1.offense.commander.damage_taken
				},
				deck: _elm_lang$core$Native_List.toArray(v._1.offense.deck).map(
					function (v) {
						return {attack: v.attack, health: v.health, delay: v.delay};
					}),
				hand: _elm_lang$core$Native_List.toArray(v._1.offense.hand).map(
					function (v) {
						return {attack: v.attack, health: v.health, delay: v.delay};
					}),
				line: _elm_lang$core$Native_Array.toJSArray(v._1.offense.line).map(
					function (v) {
						return {
							base: {attack: v.base.attack, health: v.base.health, delay: v.base.delay},
							damage_taken: v.damage_taken,
			...
			defense: {
				commander: {
					base: {health: v._1.defense.commander.base.health},
					damage_taken: v._1.defense.commander.damage_taken
				},
				deck: _elm_lang$core$Native_List.toArray(v._1.defense.deck).map(
					function (v) {
						return {attack: v.attack, health: v.health, delay: v.delay};
					}),
				hand: _elm_lang$core$Native_List.toArray(v._1.defense.hand).map(
					function (v) {
						return {attack: v.attack, health: v.health, delay: v.delay};
					}),
				line: _elm_lang$core$Native_Array.toJSArray(v._1.defense.line).map(
					function (v) {
						return {
							base: {attack: v.base.attack, health: v.base.health, delay: v.base.delay},
							damage_taken: v.damage_taken,
...
var _user$project$Simulator$endBattle = function (battle) {
	var victor = function () {
	...
	return {
		ctor: '_Tuple2',
		_0: battle,
		_1: _user$project$Simulator$battleEnd(
			{ctor: '_Tuple2', _0: victor, _1: battle})
	};
};
...
var _user$project$Simulator$matchup = _elm_lang$core$Native_Platform.incomingPort(
	'matchup',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (attacker) {
...
var _user$project$Simulator$maybeMelee = F2(
	function (pos, battle) {
		...
		return (_elm_lang$core$Native_Utils.cmp(line_len, pos) > 0) ? _user$project$Simulator$goto(
			_user$project$Simulator$Melee(pos)) : _user$project$Simulator$goto(_user$project$Simulator$RemoveDead);
	});
...
var _user$project$Simulator$maybePlay = function (battle) {
	...
	return cardChoice ? (_user$project$Simulator$quickChoice ? _user$project$Simulator$goto(
		_user$project$Simulator$Play(0)) : _user$project$Simulator$awaitChoice(battle)) : (anyCards ? _user$project$Simulator$goto(
...
var _user$project$Simulator$maybeDrawCard = function (battle) {
	...
	return (needCard && cardAvailable) ? _user$project$Simulator$goto(_user$project$Simulator$Draw) : _user$project$Simulator$maybePlay(battle);
};
var _user$project$Simulator$ReduceDelay = {ctor: 'ReduceDelay'};
var _user$project$Simulator$newMatchUp = F2(
	function (matchup, _p6) {
		return {
			ctor: '_Tuple2',
			_0: _user$project$Simulator$setupBattle(matchup),
			_1: _user$project$Simulator$goto(_user$project$Simulator$ReduceDelay)
		};
	});
var _user$project$Simulator$takeSides = function (battle) {
	var _p7 = function () {
		var _p8 = A2(_elm_lang$core$Basics_ops['%'], battle.turn, 2);
		switch (_p8) {
			case 1:
				return {ctor: '_Tuple2', _0: battle.offense, _1: battle.defense};
			case 0:
				return {ctor: '_Tuple2', _0: battle.defense, _1: battle.offense};
			default:
				return _elm_lang$core$Native_Utils.crashCase(
					'Simulator',
					{
	...
	return {
		...
		_0: _elm_lang$core$Native_Utils.update(
			battle,
			{offense: off_, defense: def_, turn: battle.turn + 1}),
		_1: _user$project$Simulator$goto(_user$project$Simulator$ReduceDelay)
	};
};
var _user$project$Simulator$TakeSides = {ctor: 'TakeSides'};
var _user$project$Simulator$endTurn = function (battle) {
	return _elm_lang$core$Native_Utils.eq(battle.turn, _user$project$Simulator$maxTurns) ? _user$project$Simulator$endBattle(battle) : {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			battle,
			{offense: battle.defense, defense: battle.offense}),
		_1: _user$project$Simulator$goto(_user$project$Simulator$TakeSides)
	};
};
	...
	function (pos, battle) {
		...
		if (_p10.ctor === 'Nothing') {
			return {
				ctor: '_Tuple2',
				_0: battle,
				_1: _user$project$Simulator$goto(_user$project$Simulator$RemoveDead)
			};
		} else {
			var _p12 = _p10._0;
			var reduceHealth = F2(
			...
			var attack = _p12.base.attack;
			if (_user$project$Simulator$isAlive(_p12) && _user$project$Simulator$isActive(_p12)) {
				var _p11 = def;
				if (_p11.ctor === 'Nothing') {
					...
					return _user$project$Simulator$isAlive(reducedHealthComm) ? A2(_user$project$Simulator_ops['=>'], battle_, maybeMeleeNext) : {
						ctor: '_Tuple2',
						_0: battle_,
						_1: _user$project$Simulator$goto(_user$project$Simulator$EndBattle)
					};
				} else {
					var reducedHealthUnit = A2(reduceHealth, attack, _p11._0);
...
var _user$project$Simulator$maybeEndTurn = function (battle) {
	return _elm_lang$core$Native_Utils.eq(battle.turn, _user$project$Simulator$maxTurns) ? _user$project$Simulator$goto(_user$project$Simulator$EndBattle) : _user$project$Simulator$goto(_user$project$Simulator$TakeSides);
};
var _user$project$Simulator$update = F2(
	function (msg, battle) {
		return function () {
			...
			switch (_p13.ctor) {
				case 'NewMatchUp':
					return _user$project$Simulator$newMatchUp(_p13._0);
				case 'TakeSides':
				...
				case 'Play':
					return A2(
						_user$project$Simulator_ops['>>>'],
						_user$project$Simulator$playCard(_p13._0),
						_user$project$Simulator$maybeStartMelee);
				case 'Melee':
					return _user$project$Simulator$melee(_p13._0);
				case 'RemoveDead':
					return A2(_user$project$Simulator_ops['>>>'], _user$project$Simulator$removeDead, _user$project$Simulator$maybeEndTurn);
				case 'EndBattle':
					return _user$project$Simulator$endBattle;
				default:
					return _user$project$Simulator$report;
			}
		}()(battle);
	});
var _user$project$Simulator$NewMatchUp = function (a) {
	return {ctor: 'NewMatchUp', _0: a};
};
var _user$project$Simulator$subs = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Simulator$play(_user$project$Simulator$Play),
			_1: {
				ctor: '::',
				_0: _user$project$Simulator$getState(_user$project$Simulator$GetState),
				_1: {
					ctor: '::',
					_0: _user$project$Simulator$matchup(_user$project$Simulator$NewMatchUp),
					_1: {ctor: '[]'}
				}
			}
		});
